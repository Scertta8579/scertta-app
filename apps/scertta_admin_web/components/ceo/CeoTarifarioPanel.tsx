...
import CeoLiquidacionesWallet from "./CeoLiquidacionesWallet";
    ...
    <div className="space-y-6">
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 rounded-xl border px-3 py-2.5 text-left text-sm font-medium transition ${
                    activeCat === c
                      ? "border-scertta-blue bg-scertta-blue/10 text-scertta-blue"
            ...
            {loading ? (
              ...
              <>
                <div className="mb-6 flex items-start gap-3">
                  <div className="rounded-xl bg-scertta-blue/10 p-3 text-scertta-blue">
                  ...
                  <div className="mt-6 rounded-xl border border-violet-500/25 bg-violet-500/5 p-4 dark:bg-violet-950/25">
                    <label className="flex cursor-pointer items-start gap-3">
                      <input
                        ...
                        className="mt-1 rounded border-black/20 accent-scertta-blue"
                      />
                      <span>
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-xl bg-scertta-blue px-5 py-2.5 text-sm font-semibold text-white disabled:opacity-50"
                >
                  {saving ? (
                    <Loader2 className="h-4 w-4 animate-spin" />
                  ) : (
      ...
      {panelTab === "comisiones" ? (
        <div className="max-w-lg rounded-2xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-950">
          <div className="mb-4 flex items-center gap-2">
            <Percent className="h-5 w-5 text-scertta-blue" />
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-scertta-blue px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-50"
            >
              {savingCom ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
