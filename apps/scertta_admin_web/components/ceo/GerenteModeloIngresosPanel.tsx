      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-4">
          <div>
            <label className="flex items-center gap-2 text-sm font-medium">
              <span className="inline-flex h-2 w-2 rounded-full bg-rutmy-agua" />
              Comisión Scertta (%)
            </label>
            ...
            <div className="mt-2 flex items-center gap-3">
              <input
                ...
                className="h-2 w-full max-w-xs accent-rutmy-agua"
              />
              <input
                type="number"
                min={0}
        ...
        <div className="space-y-4 rounded-xl border border-black/10 bg-zinc-50 p-4 dark:border-white/10 dark:bg-zinc-900/50">
          ...
          <div className="flex h-4 w-full overflow-hidden rounded-full bg-black/10 dark:bg-white/10">
            ...
            />
            <div
              className="h-full bg-rutmy-agua transition-all"
          ...
          <div className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-rutmy-agua/30 bg-rutmy-agua/5 px-3 py-2">
              <p className="text-xs text-apple-gray">Comisión Scertta</p>
              <p className="font-semibold tabular-nums text-rutmy-agua">
                {new Intl.NumberFormat("es-AR", {
                  style: "currency",
                  currency: "ARS",
                  maximumFractionDigits: 0,
              ...
              <p className="text-xs text-rutmy-agua/80">
