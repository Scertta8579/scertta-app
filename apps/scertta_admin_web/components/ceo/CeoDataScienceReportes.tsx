      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-950">
              ...
              <li key={o.id}>
                <label className="flex cursor-pointer gap-3 rounded-xl border border-black/5 p-3 transition hover:bg-black/[0.02] dark:border-white/10 dark:hover:bg-white/5">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-black/20 accent-scertta-blue dark:border-white/30"
                  />
                  <span>
          ...
          <button
            ...
            disabled={exporting}
            className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-scertta-blue px-4 py-3 text-sm font-semibold text-white transition hover:opacity-95 disabled:opacity-50 sm:w-auto"
          >
            {exporting ? (
