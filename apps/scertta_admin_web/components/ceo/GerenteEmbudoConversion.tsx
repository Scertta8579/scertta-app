          ...
          return (
            <div key={s.key} className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <div className="flex w-full min-w-0 items-center gap-3 sm:w-52">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-rutmy-agua/10 text-rutmy-agua">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-2">
                <div className="h-3 flex-1 overflow-hidden rounded-full bg-black/5 dark:bg-white/10">
                  <div
                    className="h-full rounded-full bg-gradient-to-r from-rutmy-agua to-violet-500 transition-all duration-500"
                    style={{ width: `${w}%` }}
                  />
                </div>
                {i < STAGES.length - 1 ? (
