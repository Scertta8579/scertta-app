...
import CeoContabilidadFiscalModule from "@/components/ceo/CeoContabilidadFiscalModule";
            ...
            <button
              ...
              className={`rounded-xl px-3 py-2 text-xs font-medium sm:text-sm ${
                contSub === id
                  ...
                  : "border border-black/10 text-apple-gray hover:bg-black/5 dark:border-white/15 dark:hover:bg-white/10"
              }`}
            >
              {label}
            </button>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-950">
          <div className="flex items-center justify-between">
            <Receipt className="h-5 w-5 text-scertta-blue" />
            {loading ? (
