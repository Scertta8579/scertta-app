  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-2xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-950">
          <div className="mb-4 flex items-center gap-2">
            <Banknote className="h-5 w-5 text-rutmy-agua" />
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <label className="flex cursor-pointer items-center gap-2 text-xs text-apple-gray">
              <input
                ...
                className="rounded border-black/20 accent-rutmy-agua"
              />
            ...
            <button
              ...
              className="rounded-xl bg-rutmy-agua px-4 py-2.5 text-sm font-semibold text-rutmy-deep disabled:opacity-40"
            >
