...
import CeoEmbudoConversion from "@/components/ceo/CeoEmbudoConversion";
import CeoRiesgoBilleterasPanel from "@/components/ceo/CeoRiesgoBilleterasPanel";
...
export default function CeoAnaliticaOperaciones() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        {(
          [
            ...
            ["embudo", "Embudo de conversión"],
            ["riesgo", "Riesgo / billeteras"],
          ] as const
        ).map(([id, label]) => (
          <button
            key={id}
      ...
      {sub === "embudo" ? <CeoEmbudoConversion /> : null}
      {sub === "riesgo" ? <CeoRiesgoBilleterasPanel /> : null}
        ...
        <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-950">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="rounded-xl bg-scertta-blue/10 p-2.5">
                <Car className="h-6 w-6 text-scertta-blue" />
              </div>
              <div>
      ...
      <section aria-label="Gestión de casos de soporte">
        <h3 className="mb-4 flex items-center gap-2 text-lg font-semibold">
          <Headphones className="h-5 w-5 text-scertta-blue" />
      ...
      >
        ...
        <div className="rounded-2xl border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-zinc-950">
          <div className="flex items-center gap-2 border-b border-black/5 pb-4 dark:border-white/10">
            <UserCog className="h-5 w-5 text-scertta-blue" />
