...
2. Selecciona tu proyecto: **cmuhwyxmluhnlzcasceq**
3. Ve a: **Settings** → **API**
4. Copia estos dos valores:

```
📋 Project URL:
https://cmuhwyxmluhnlzcasceq.supabase.co

📋 Anon Key (anon public):
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNtdWh3eXhtbHVobmx6Y2FzY2VxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDk4NjQwMDAsImV4cCI6MjAyNTQ0MDAwMH0.XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
```
...
class SupabaseConfig {
  ...
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNtdWh3eXhtbHVobmx6Y2FzY2VxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDk4NjQwMDAsImV4cCI6MjAyNTQ0MDAwMH0.XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
