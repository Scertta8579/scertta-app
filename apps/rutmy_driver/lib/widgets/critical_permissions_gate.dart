...
import 'package:flutter_shared/services/critical_permissions_service.dart';
  ...
  Widget build(BuildContext context) {
    if (_checking || _unlocked) {
      ...
      return const Scaffold(
        ...
        body: Center(
          child: CircularProgressIndicator(color: Color(0xFF64DEB2)),
        ),
      );
    }
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.map_rounded, color: Color(0xFF64DEB2), size: 56),
