...
class _SettingsScreenState extends State<SettingsScreen> {
  String _correo = 'conductor@scertta.com';
  String _telefono = '';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            leading: Icon(Icons.group, color: Colors.grey[800], size: 24),
            title: const Text(
              'Contactos de emergencia',
              style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w500),
            ),
            subtitle: Text(
              'Agregar contacto / Enviar ubicación',
              style: TextStyle(color: Colors.grey[600], fontSize: 13),
            ),
            trailing: Icon(Icons.chevron_right, color: Colors.grey[400], size: 24),
            onTap: () {},
          ...
          ListTile(
            ...
            trailing: Switch(
              value: _grabarViajes,
              onChanged: (v) => setState(() => _grabarViajes = v),
              activeTrackColor: kScerttaCyan,
              activeColor: Colors.white,
            ),
            onTap: () => setState(() => _grabarViajes = !_grabarViajes),
          ),
          const Divider(height: 32),
