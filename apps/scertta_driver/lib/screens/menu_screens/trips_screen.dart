          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Reporte de objeto — pasajero: ${driverName ?? 'N/D'}', 
                    style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black), 
                  ),
                  const SizedBox(height: 12),
                  Text(
                    'Detalle lo encontrado o lo reportado por el pasajero (color, ubicación en el vehículo, etc.).',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Califica cómo fue el viaje con el pasajero${widget.driverName != null && widget.driverName!.isNotEmpty ? ' (${widget.driverName})' : ''}',
