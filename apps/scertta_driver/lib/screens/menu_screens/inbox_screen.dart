...
class InboxScreen extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
          _buildMessageTile(
            ...
            'Gracias por unirte a nuestra comunidad. Completa tu perfil.',
            'Hace 2 días',
            true,
          ),
          _buildMessageTile(
            'Promoción Exclusiva',
            'Tienes un 10% de descuento en tu próximo viaje con Scertta Auto.',
            'Hace 5 días',
            false,
          ),
        ],
  ...
  Widget _buildMessageTile(String title, String subtitle, String time, bool isNew) {
    return Card(
      ...
      color: isNew ? kScerttaTealInbox.withOpacity(0.05) : Colors.white,
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          backgroundColor: kScerttaTealInbox,
